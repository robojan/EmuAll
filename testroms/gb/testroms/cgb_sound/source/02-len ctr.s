...
test_chan:
     set_test 2,"Length becoming 0 should clear status" ; c254
     call begin
     delay_apu 3
     ...
     set_test 13,"Disabling DAC should disable channel immediately" ; c608
     call begin
     ...
     set_test 14,"Disabled DAC should prevent enable at trigger" ; c666
     call begin
     wchn 0,$00     ; if wave channel, this disables DAC
     wchn 2,$07     ; if square/noise channel, this disables DAC
