...
void videoInitMode0() {
	...
	REG_BG1CNT = BG_256_COLOR | BG_SIZE_0 | BG_TILE_BASE(0) | BG_MAP_BASE(12) | BG_PRIORITY(1);
	REG_BG0CNT = BG_256_COLOR | BG_SIZE_0 | BG_TILE_BASE(0) | BG_MAP_BASE(13) | BG_PRIORITY(0);
...
void videoInitObjects() {
	...
	OAM[2].attr2 = OBJ_CHAR(0) | OBJ_PRIORITY(1);
